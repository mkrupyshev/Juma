...
(function() {
  $(function() {
    ...
    $b = $(".chooser");
    $e = $b.element("box");
    return $e.on("shown.bs.collapse", function(e) {
      var headerHeight;
      headerHeight = $(".header").outerHeight();
      return $('body').scrollTo($(this).closest(".chooser__item").offset().top, 400);
    });
  });
...
(function() {
  $(function() {
    var $block, calculateBox,
      _this = this;
    $block = $('.visual');
    calculateBox = function() {
      var setHeight, winHeight, winWidth;
    ...
    $(window).resize(calculateBox);
    calculateBox();
    return $block.addClass('visual_init').trigger('resized');
  });
...
(function() {
  ...
  $(function() {
    var disableScroll, enableScroll, preventDefault, preventDefaultForScrollKeys;
    ...
    disableScroll();
    return $(document).on("fullyloaded", function() {
